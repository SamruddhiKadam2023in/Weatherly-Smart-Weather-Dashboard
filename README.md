...
| Data Source | [OpenWeatherMap API](https://openweathermap.org/api) — Current Weather, 5-Day Forecast, UV Index, and Geocoding endpoints |
...
- Weather, forecast, UV index, and geocoding data from [OpenWeatherMap](https://openweathermap.org/)
- Icons by [Font Awesome](https://fontawesome.com/)
- UI components via [Bootstrap](https://getbootstrap.com/) and [jQuery UI](https://jqueryui.com/)
- Date/time handling via [Day.js](https://day.js.org/)
